...
export default function WhyChooseUs() {
  ...
  const features = [
    ...
    {
      title: 'Quality Food',
      description: 'We partner with the best restaurants to ensure you get fresh, delicious meals every time.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Easy Ordering',
      description: 'Our user-friendly app and website make ordering your favorite food quick and simple.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Multiple payment options with bank-level security to keep your transactions safe.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Live Tracking',
      description: 'Track your order in real-time from preparation to delivery with our live tracking system.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-gray-800 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border border-gray-700"
            >
